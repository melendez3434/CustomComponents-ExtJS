# Installation
- Install Sencha CMD 6.7.0.63
- Open new terminal and navigate to CustomComponentExtJS folder project
- run the command: sencha app refresh
- then run the command: sencha app watch
- access the url http://localhost:1841 on your browser to see the app running
...
This area is intended for overrides like these:
    ...
    Ext.define('CustomComponentExtJS.overrides.foo.Bar', {
